              ...
              <EmptyState
                ...
                description={
                  search || filterType !== "Semua"
                    ...
                    : "Belum ada riwayat klasifikasi dalam database lokal."
                }
                actionLabel={search || filterType !== "Semua" ? undefined : "Mulai Klasifikasi"}
                actionHref="/dashboard/classification"
                    ...
                    <tr key={item.id} className="hover:bg-muted/10 transition-colors">
                      ...
                      <td className="p-4 text-right whitespace-nowrap">
                        <div className="flex justify-end gap-1.5">
                          <Button variant="outline" size="icon" asChild className="rounded-lg h-8 w-8" title="Lihat Detail">
                            <Link href={`/dashboard/classification/${item.id}`}>
